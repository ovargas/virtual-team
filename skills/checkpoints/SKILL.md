...
|---|---|---|
| `/debug` | 4 phases (Reproduce → Document) | `commands/debug.md` |
| `/epic` | 6 phases (Decision Sync → Document) | `commands/epic.md` |
| `/feature` | 6 phases (Understand → Stories) | `commands/feature.md` |
| `/plan` | 5 phases (Arch Gate → Update Backlog) | `commands/plan.md` |
