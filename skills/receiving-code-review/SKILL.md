...
- `/implement` — Layer 0 (behavioral discipline), loaded alongside `test-driven-development` and `verification-before-completion`
- `/review` — When processing review results (receiving side)
